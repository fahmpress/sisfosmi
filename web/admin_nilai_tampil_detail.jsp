...
<html>
    ...
    <body>
        <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Detail Nilai <b><%=nm_mhs%></b></h3>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
        ...
        <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <center>
                            <a href="admin_home.jsp?link=nilai_tambah&&nim=<%=nim%>"><i class="fa fa-file"></i> Tambah nilai</a>
                            </center>
                         </div>
                    </div>
        </div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
												...
												int sks = rs1.getInt(24);
                                                                                                ...
                                                                                                out.println("<td><center><a href='admin_home.jsp?link=nilai_edit&&nim=" +nim+ "&&kd_matkul=" + rs1.getString ("kd_matkul") + "'><i class='fa fa-edit'></i></a></center></td>");
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
												...
												int sks = rs2.getInt(24);
                                                                                                ...
                                                                                                out.println("<td><center>" +nilai+ "</center></td>");
                                                                                                out.println("<td><center><a href='admin_home.jsp?link=nilai_edit&&nim=" +nim+ "&&kd_matkul=" + rs2.getString ("kd_matkul") + "'><i class='fa fa-edit'></i></a></center></td>");
                                                                                                    if (nilai.equals("A")){angka_mutu=sks*4;} 
                                                                                                        else if (nilai.equals("B")){angka_mutu=sks*3;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
												...
												int sks = rs3.getInt(24);
                                                                                                ...
                                                                                                out.println("<td><center>" +nilai+ "</center></td>");
                                                                                                out.println("<td><center><a href='admin_home.jsp?link=nilai_edit&&nim=" +nim+ "&&kd_matkul=" + rs3.getString ("kd_matkul") + "'><i class='fa fa-edit'></i></a></center></td>");
                                                                                                    if (nilai.equals("A")){angka_mutu=sks*4;} 
                                                                                                        else if (nilai.equals("B")){angka_mutu=sks*3;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
												...
												int sks = rs4.getInt(24);
                                                                                                ...
                                                                                                out.println("<td><center>" +nilai+ "</center></td>");
                                                                                                out.println("<td><center><a href='admin_home.jsp?link=nilai_edit&&nim=" +nim+ "&&kd_matkul=" + rs4.getString ("kd_matkul") + "'><i class='fa fa-edit'></i></a></center></td>");
                                                                                                    if (nilai.equals("A")){angka_mutu=sks*4;} 
                                                                                                        else if (nilai.equals("B")){angka_mutu=sks*3;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
												...
												int sks = rs5.getInt(24);
                                                                                                ...
                                                                                                out.println("<td><center>" +nilai+ "</center></td>");
                                                                                                out.println("<td><center><a href='admin_home.jsp?link=nilai_edit&&nim=" +nim+ "&&kd_matkul=" + rs5.getString ("kd_matkul") + "'><i class='fa fa-edit'></i></a></center></td>");
                                                                                                    if (nilai.equals("A")){angka_mutu=sks*4;} 
                                                                                                        else if (nilai.equals("B")){angka_mutu=sks*3;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
												...
												int sks = rs6.getInt(24);
                                                                                                ...
                                                                                                out.println("<td><center>" +nilai+ "</center></td>");
                                                                                                out.println("<td><center><a href='admin_home.jsp?link=nilai_edit&&nim=" +nim+ "&&kd_matkul=" + rs6.getString ("kd_matkul") + "'><i class='fa fa-edit'></i></a></center></td>");
                                                                                                    if (nilai.equals("A")){angka_mutu=sks*4;} 
                                                                                                        else if (nilai.equals("B")){angka_mutu=sks*3;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
                                                                                                        else if (nilai.equals("C")){angka_mutu=sks*2;} 
